    ...
    document.getElementById('playSingle').addEventListener('click', function() {
        ...
        <div class="mt-3 mb-3 text-center text-light">
            <span id="backArrow" style="cursor: pointer;">
                <i class="bi bi-caret-left-fill text-light me-1"></i>
            </span>Play 1v1 match:
        </div>
        <div class="mb-3 text-center">
            ...
            <button class="btn btn-primary btn-sm shadow-sm text-light col-6 mb-3" data-bs-toggle="modal" data-bs-target="#matchModal">online
            </button>
        </div>
        `;
